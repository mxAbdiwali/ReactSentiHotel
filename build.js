...
ReactDom.render(
    React.createElement(App, {brand: "SentiHotel"}),
    document.getElementById('root')
);
},{"./component/header.js":26,"react":24,"react-dom":21}],26:[function(require,module,exports){
const React = require('react');
const ReactDom = require('react-dom');
     ...
     render(){
         return(
            React.createElement("nav", {className: "navbar navbar-light bg-light"}, 
                React.createElement("a", {className: "navbar-brand"}, console.log(this.state)), 
